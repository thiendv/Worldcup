...
public class MatchAdapter extends BaseExpandableListAdapter implements OnClickListener {
	...
	public MatchAdapter(Context pContext, ExpandableListView pExpandableListView,
	...
	public View getChildView(int arg0, int arg1, boolean arg2, View view, ViewGroup arg4) {
		...
		final MatchItem item = (MatchItem)mGroupCollection.get(arg0).getChildList().get(arg1);
		ChildHolder holder;
		if(view ==null){
			view = LayoutInflater.from(mContext).inflate(R.layout.math_view, null);
		...
		holder.tvTeam1.setText(item.getTeam1().getName());
		holder.tvTeam2.setText(item.getTeam2().getName());
